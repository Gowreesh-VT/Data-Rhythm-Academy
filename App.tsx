...
type Page = 'landing' | 'login' | 'register' | 'booking' | 'payment';
...
export default function App() {
  ...
  switch (currentPage) {
    ...
    case 'booking':
      return <SlotBookingPage onNavigate={navigate} user={user} onLogout={handleLogout} />;
    case 'payment':
      return <PaymentPage onNavigate={navigate} user={user} onLogout={handleLogout} />;
    default:
      return <LandingPage onNavigate={navigate} user={user} onLogout={handleLogout} />;
  }
}