...
export function AboutPage({ onNavigate }: AboutPageProps) {
  const teamMembers = [
    ...
    {
      name: "Dr.Meignanamoorthi D",
      role: "Senior Instructor - Python & Data Science",
      bio: "Data scientist and researcher with a PhD in Data Science and 10+ years of teaching experience",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=meignanamoorthi&backgroundColor=b6e3f4",
      expertise: ["Computer Networks", "Data Science", "Python", "Java", "C & C++"]
    },
    // {
    //   name: "Alex Chen",
