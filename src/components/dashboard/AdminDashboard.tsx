...
interface CourseFormContentProps {
  course: Course;
  onUpdate: (courseId: string, updatedData: Partial<Course>) => Promise<void>;
  isUpdating: boolean;
  onCancel: () => void;
}
...
const CourseFormContent: React.FC<CourseFormContentProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await onUpdate(course.id, {
      ...
      // Note: For admin syllabus management, we focus on the overview content
      // Lessons structure updates would require a more complex implementation
    });
  };
  ...
  const updateLesson = (index: number, field: string, value: string | number) => {
    setFormData(prev => ({
      ...prev,
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ onNavigate, onLogout }) => {
  ...
  const handleUpdateSyllabus = async (courseId: string, updatedData: Partial<Course>) => {
    ...
    try {
      ...
      logger.info('Course syllabus updated successfully', { courseId, updatedData });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="users" className="space-y-6">
          ...
          <TabsContent value="settings" className="space-y-6">
            ...
            {/* Course Syllabus Management Section */}
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">
                  Configure and edit course syllabi that appear in the enrollment overview
                </p>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                          ...
                          <CardHeader className="pb-3">
                            <div className="flex items-start space-x-3">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-600 mt-1">by {course.instructorName}</p>
        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          ...
          {selectedCourseForSyllabus && (
            <CourseFormContent 
              ...
              isUpdating={updatingSyllabus}
              onCancel={() => setShowSyllabusModal(false)}
            />
          )}
        </DialogContent>
      </Dialog>
